...
_config_php(){
    ...
    sed -i 's/;opcache.save_comments=.*/opcache.save_comments=1/g' ${php71_location}/etc/php.ini
...
EOF
    ...
    ${php71_location}/sbin/php-fpm -y ${php71_location}/etc/default.conf >/dev/null 2>&1
